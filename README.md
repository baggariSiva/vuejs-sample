# Vue.js example demo CI/CD pipeline


<a href="https://dash.elest.io/deploy?source=cicd&social=Github&url=https://github.com/elestio-examples/vuejs"><img src="src\assets\deploy-on-elestio.png" alt="Deploy on elestio.io" width="180px" /></a>

Example application and CI/CD pipeline showing how to deploy a Vue.js website to elestio.

<img src="src\assets\screenshot-1.jpg" alt="screenshot of the example app" width="100%" />
...
But for this Vue.js website example, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the Vue.js-example repo otherwise you can directly insert a git repo URL to deploy the Vue.js website.
